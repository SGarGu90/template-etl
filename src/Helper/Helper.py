...
class HelperClass:
    ...
    @staticmethod
    def print_log_error_levels():
        """Print meaning for each type of error
        """
        print("DEBUG: Detailed information, typically of interest only when diagnosing problems.")
        print("INFO: Confirmation that things are working as expected.")
        print("WARNING: An indication that something unexpected happened, or indicative of some problem in the near future (e.g. 'disk space low'. The software is still working as expected")
        print("ERROR: Due to a more serious problem, the software has not been able to perform some function")
        print("CRITICAL: A serious error, indicating that the program itself may be unable to continue running")
